...
<div id="k2Container" class="at-item-page itemView<?php echo ($this->item->featured) ? ' itemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
  ...
  <div class="itemBody">
	  ...
	  <!-- Item Image -->
	  <div class="at-itemImageBlock item-image">
...
?>
 ...
 <!-- Related items by tag -->
	<div class="itemRelated">
		...
		$key = $key + 1;
		$rowcount = (((int) $key - 1) % 3) + 1;
		$row = $itemcount / 3;
		if ($rowcount == 1) : ?>	
			<div class="items-row cols-3 <?php echo 'row-'.(int)$row; ?> row-fluid">
		<?php endif; ?>
				    ...
				    <div class="at-intro-item">
						<div class="ch-info">
							...
							<?php if($this->item->params->get('itemRelatedIntrotext')): ?>
								<div class="itemRelIntrotext"><?php echo str_replace('...', '', JHtml::_('string.truncate', ($item->introtext), 100));?>
								</div>
							<?php endif; ?>
							</div>
						</div>
		...
		<?php if (($rowcount == 3) or ($counter == count($this->relatedItems))) :?>
			</div>
		<?php endif; ?>
		<?php endforeach; ?>
		</div>
