...
{
	protected static $_cr = '<div id="avatar-template-copyright" style="color:red; text-transform: uppercase; font-weight: bold;">HOTLINE: 0935 783 568</div>';
	protected static $_version = '1.1.0';
	protected static $_edition = 'Free';
	protected static $_templateFullName = 'Amazing Template Framework';
	protected static $_instances;
	public static $_paths = null;
	public static $_templateName = 'AT Arrowzex';
