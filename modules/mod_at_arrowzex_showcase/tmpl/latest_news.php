...
?>
<div class="at-arrowzex-latest-news">
		<?php
					...
					<?php endif; ?>
						...
						<div class="at-intro-item-wrap span<?php echo round((12 / $primaryColumns));?>">
							<div class="at-image-intro-item">
								...
								<?php endif;?>
								<div class="at-published">
									<?php echo JText::sprintf(JHtml::_('date', $item->publish_up, JText::_('d M'))); ?>
								</div>
							</div>
						    <div class="at-intro-item">
								<div class="ch-info">
									...
									<div class="ch-info-content">
										...
										<?php if($articleIntro == 'true') echo str_replace('...', '', JHtml::_('string.truncate', ($item->introtext), 100));?>
